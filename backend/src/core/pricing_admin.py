...
_DEFAULT_PRICING_ENTRIES: list[dict[str, Any]] = [
    ...
    {
        "pricingId": "luma.ray-3.2.video-edit.720p",
        "label": "Luma Ray 3.2 video edit 720p",
        "provider": "Luma",
        "appModelId": "ray-3.2-720p",
        "providerModel": "ray-3.2",
        "category": "video_generation",
        "billingUnit": "per_second",
        "rates": {
            "output_per_second_usd_720p": 0.216,
        },
        "assumptions": "Luma Agents pricing publishes Ray 3.2 video edit as $1.08 for 5s or $2.16 for 10s at 720p SDR.",
        "sourceUrl": "https://docs.agents.lumalabs.ai/guides/pricing/",
        "sourceCheckedAt": "2026-06-21",
        "notes": "The published 5s and 10s examples imply a stable $0.216/sec rate for 720p video edit.",
    },
    {
        "pricingId": "luma.ray-3.2.video-edit.1080p",
        "label": "Luma Ray 3.2 video edit 1080p",
        "provider": "Luma",
        "appModelId": "ray-3.2-1080p",
        "providerModel": "ray-3.2",
        "category": "video_generation",
        "billingUnit": "per_second",
        "rates": {
            "output_per_second_usd_1080p": 0.432,
        },
        "assumptions": "Luma Agents pricing publishes Ray 3.2 video edit as $2.16 for 5s or $4.32 for 10s at 1080p SDR.",
        "sourceUrl": "https://docs.agents.lumalabs.ai/guides/pricing/",
        "sourceCheckedAt": "2026-06-21",
        "notes": "The published 5s and 10s examples imply a stable $0.432/sec rate for 1080p video edit.",
    },
    {
    ...
    },
    {
        ...
        "assumptions": "Runway API pricing page quotes Aleph 2.0 at 28 credits/sec with a 56-credit minimum; registry treats one credit as $0.01.",
        "sourceUrl": "https://docs.dev.runwayml.com/guides/pricing/",
        "sourceCheckedAt": "2026-06-21",
        "notes": "The app keeps the legacy app model id for compatibility, but requests now send Aleph 2.0. The current estimator records the per-second rate and does not yet apply Runway's 56-credit minimum.",
    },
    {
    ...
    {
        "pricingId": "fal.sam2.image",
        "label": "fal.ai SAM 2 image segmentation",
        "provider": "fal.ai",
        "appModelId": "fal-ai/sam2/image",
        "providerModel": "fal-ai/sam2/image",
        "category": "image_segmentation",
        "billingUnit": "per_image",
        "rates": {
            "per_image_usd": 0.0,
        },
        "assumptions": "fal.ai's published SAM 2 llms.txt currently lists the model at $0 per compute seconds.",
        "sourceUrl": "https://fal.ai/models/fal-ai/sam2/image/llms.txt",
        "sourceCheckedAt": "2026-06-21",
        "notes": "Tracked so segmentation activity appears in usage logs even while the provider-listed price is zero.",
    },
    {
